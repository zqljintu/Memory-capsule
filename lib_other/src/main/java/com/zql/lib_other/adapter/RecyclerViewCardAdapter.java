...
import com.zql.lib_other.view.list.ListPresenter;
...
public class RecyclerViewCardAdapter extends RecyclerView.Adapter<RecyclerViewCardAdapter.Viewholder> {
    ...
    private ListPresenter listActivityImp;
    ...
    public RecyclerViewCardAdapter(ArrayList<NoteBean>mnotelist, Context mcontext, ListPresenter mlistactivityimp){
