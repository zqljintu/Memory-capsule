...
public final class DeviceUtils {
    ...
    public static boolean isAdbEnabled() {
        return Settings.Secure.getInt(
                GlobalUtils.getApp().getContentResolver(),
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) GlobalUtils.getApp()
    ...
    public static boolean isTablet() {
        return (GlobalUtils.getApp().getResources().getConfiguration().screenLayout
    ...
    public static boolean isEmulator() {
        ...
        String operatorName = "";
        TelephonyManager tm = (TelephonyManager) GlobalUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) {
        ...
        boolean checkDial = intent.resolveActivity(GlobalUtils.getApp().getPackageManager()) != null;
