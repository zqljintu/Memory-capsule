...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        GlobalUtils.getApp().startActivity(
    ...
    public static GlobalUtils.Task<Boolean> isAvailableAsync(@NonNull final GlobalUtils.Callback<Boolean> callback) {
        return GlobalUtils.doAsync(new GlobalUtils.Task<Boolean>(callback) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByPingAsync(final GlobalUtils.Callback<Boolean> callback) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static GlobalUtils.Task<Boolean> isAvailableByPingAsync(final String ip,
                                                                   @NonNull final GlobalUtils.Callback<Boolean> callback) {
        return GlobalUtils.doAsync(new GlobalUtils.Task<Boolean>(callback) {
            @RequiresPermission(INTERNET)
            @Override
            public Boolean doInBackground() {
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByDnsAsync(final GlobalUtils.Callback<Boolean> callback) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static GlobalUtils.Task isAvailableByDnsAsync(final String domain,
                                                         @NonNull final GlobalUtils.Callback<Boolean> callback) {
        return GlobalUtils.doAsync(new GlobalUtils.Task<Boolean>(callback) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) GlobalUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) GlobalUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) GlobalUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
     ...
     */
    @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
    public static GlobalUtils.Task<Boolean> isWifiAvailableAsync(@NonNull final GlobalUtils.Callback<Boolean> callback) {
        return GlobalUtils.doAsync(new GlobalUtils.Task<Boolean>(callback) {
            @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
            @Override
            public Boolean doInBackground() {
     ...
     * @return the task
     */
    public static GlobalUtils.Task<String> getIPAddressAsync(final boolean useIPv4,
                                                             @NonNull final GlobalUtils.Callback<String> callback) {
        return GlobalUtils.doAsync(new GlobalUtils.Task<String>(callback) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static GlobalUtils.Task<String> getDomainAddressAsync(final String domain,
                                                                 @NonNull final GlobalUtils.Callback<String> callback) {
        return GlobalUtils.doAsync(new GlobalUtils.Task<String>(callback) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) GlobalUtils.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
