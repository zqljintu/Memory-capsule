...
public final class ShellUtils {
     ...
     * @return the task
     */
    public static GlobalUtils.Task<CommandResult> execCmdAsync(final String command,
                                                               final boolean isRooted,
                                                               final GlobalUtils.Callback<CommandResult> callback) {
     ...
     * @return the task
     */
    public static GlobalUtils.Task<CommandResult> execCmdAsync(final List<String> commands,
                                                               final boolean isRooted,
                                                               final GlobalUtils.Callback<CommandResult> callback) {
     ...
     * @return the task
     */
    public static GlobalUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                               final boolean isRooted,
                                                               final GlobalUtils.Callback<CommandResult> callback) {
    ...
    public static GlobalUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                               final boolean isRooted,
                                                               final boolean isNeedResultMsg,
                                                               @NonNull final GlobalUtils.Callback<CommandResult> callback) {
        return GlobalUtils.doAsync(new GlobalUtils.Task<CommandResult>(callback) {
            @Override
