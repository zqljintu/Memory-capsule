...
public final class ActivityUtils {
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = GlobalUtils.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(GlobalUtils.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(GlobalUtils.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(GlobalUtils.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(GlobalUtils.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, GlobalUtils.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @Nullable final Bundle options) {
        return startActivity(intent, GlobalUtils.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, GlobalUtils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       @Nullable final Bundle options) {
        startActivities(intents, GlobalUtils.getTopActivityOrApp(), options);
    }
    ...
    public static void startLauncherActivity() {
        startLauncherActivity(GlobalUtils.getApp().getPackageName());
    }
    ...
    public static List<Activity> getActivityList() {
        return GlobalUtils.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(GlobalUtils.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return GlobalUtils.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = GlobalUtils.getActivityList();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = GlobalUtils.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(GlobalUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(GlobalUtils.getApp(), clz));
    }
    ...
    public static void rateNow(final Context context, String path) {
        ...
        try {
            ...
            if (intent.resolveActivity(context.getPackageManager()) != null) {
                ...
                intent2.setData(Uri.parse("https://play.google.com/store/apps/details?id=" + path));
    ...
    static String FEEDBACK_TITLE = "[App] Version %1$s";
    static String FEEDBACK_MESSAGE = "DeviceModel:%1$s\r\nSystemVersion:%2$s\r\n-------------------\r\n";

    public static void jumpToFeedback(Context context, String email) {
        try {
            Intent sendIntent = new Intent(Intent.ACTION_SENDTO);
            sendIntent.setData(Uri.parse(MAILTO));
            String feedbackContent = String.format(Locale.ENGLISH, FEEDBACK_MESSAGE, android.os.Build.MODEL, android.os.Build.VERSION.RELEASE);
            String versionName = BuildConfig.VERSION_NAME;
            String feedbackTitle = String.format(Locale.ENGLISH, FEEDBACK_TITLE, versionName);
            sendIntent.putExtra(Intent.EXTRA_SUBJECT, TextUtils.isEmpty(feedbackTitle) ? "" : feedbackTitle);
